...
public class MyDarculaComboBoxUI extends BasicComboBoxUI implements Border, ErrorBorderCapable {
    ...
    public MyDarculaComboBoxUI() {
    }

    // public MyDarculaComboBoxUI(float arc, Insets borderCompensation, boolean paintArrowButton) {
    //     myArc = arc;
    ...
    // @Deprecated
    // public MyDarculaComboBoxUI(JComboBox c) {
    // }

    @SuppressWarnings({"MethodOverridesStaticMethodOfSuperclass", "unused"})
    public static ComponentUI createUI(final JComponent c) {
        return new MyDarculaComboBoxUI();
    }
    ...
    private Color getBackgroundColor() {
        ...
        // }
        // jz 编辑后
        return UIUtil.getComboBoxDisabledBackground();
    }
